...
export const PRODUCTS: Product[] = [
  {
    slug: 'colunas',
    name: 'Colunas Armadas',
    h1: 'Colunas Armadas de Ferro e Aço para sua Obra em São Paulo',
    metaTitle: 'Colunas Armadas em São Paulo | Preço e Orçamento | Cursino Ferro e Aço',
    metaDescription: 'Procurando colunas armadas em São Paulo? Fabricamos colunas de ferro e aço sob medida e padronizadas com corte e dobra a partir do projeto estrutural. Entrega rápida na Grande SP.',
    shortDescription: 'Colunas prontas e armadas para sustentação estrutural, prontas para concretagem com rapidez e máxima precisão milimétrica.',
    fullDescription: 'As colunas armadas da Cursino Ferro e Aço são confeccionadas para garantir estabilidade e resistência máxima na estrutura da sua obra em São Paulo. Fornecidas prontas para montagem ou sob medida a partir das especificações do seu projeto estrutural, eliminando 100% da perda de material e acelerando o cronograma de concretagem de pilares.',
    targetAudience: ['Construtoras', 'Engenheiros', 'Empreiteiros', 'Mestres de Obra', 'Obras Residenciais', 'Reformas'],
    applications: [
      'Estruturas de sustentação vertical e pilares mestres',
      'Casas térreas, sobrados residenciais e prédios',
      'Muros de arrimo, contenções e divisas de terreno',
      'Galpões comerciais e estruturas industriais'
    ],
    advantages: [
      'Economia imediata de tempo e mão de obra no canteiro',
      'Eliminação total de desperdício e sobras de pontas de aço',
      'Armação industrial com amarração reforçada e espaçamento padrão',
      'Etiquetagem detalhada por elemento estrutural (ex: P1, P2)',
      'Entrega pontual com frota programada em São Paulo e região'
    ],
  ...
  },
  {
    slug: 'vigas',
    name: 'Vigas Armadas',
    h1: 'Vigas Armadas Estruturais sob Medida em São Paulo',
    metaTitle: 'Vigas Armadas em São Paulo | Sob Medida para sua Obra | Cursino',
    metaDescription: 'Vigas de aço armadas sob medida para sustentação de lajes e pilares em SP. Confeccionadas conforme cálculo estrutural, sem perdas de aço no canteiro. Solicite orçamento.',
    shortDescription: 'Vigas estruturais montadas com precisão milimétrica de acordo com o cálculo e projeto da sua edificação.',
    fullDescription: 'Produzimos vigas armadas para suporte de lajes, fechamentos e vigamentos superiores em toda São Paulo. Cada peça é fabricada respeitando as bitolas de aço CA-50 e CA-60, espaçamento exato de estribos e comprimentos determinados, com identificação facilitada para a equipe de armação e posicionamento nas fôrmas.',
    targetAudience: ['Construtoras', 'Engenheiros Calculistas', 'Empreiteiros', 'Reformas e Construções'],
    applications: [
      'Sustentação de lajes maciças, nervuradas ou pré-moldadas',
      'Travamento superior de alvenarias e pilares de sustentação',
      'Vigas de transição, balanços e vergas/contravergas',
      'Reforço estrutural em reformas comerciais e residenciais'
    ],
    advantages: [
      'Montagem rigorosa conforme pranchas do projeto estrutural',
      'Estribagem com espaçamento uniforme sem variações',
      'Corte e dobra industriais sem sobras ou perdas de barras',
      'Facilidade de içamento e encaixe perfeito na fôrma'
    ],
